...
public class UserDao {
    ...
    static{
        users.add(new User(1,"kty",new Date(),"password1","80800-1022"));
        users.add(new User(2,"hgd",new Date(),"password2","80800-1033"));
        users.add(new User(3,"lyg",new Date(),"password3","80800-1044"));
    }
